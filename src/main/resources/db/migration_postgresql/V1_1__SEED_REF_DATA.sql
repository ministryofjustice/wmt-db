...
INSERT INTO app.reduction_category (id, category)
OVERRIDING SYSTEM VALUE
VALUES(1, 'Personal Circumstances'),
(2, 'Community Justice Learning'),
(3, 'Work Circumstances');

INSERT INTO app.reduction_reason (id, reason, reason_short_name, category_id, allowance_percentage, max_allowance_percentage, months_to_expiry)
OVERRIDING SYSTEM VALUE
VALUES(1, 'Disability', 'Disability', 1, null, null, null),
...
INSERT INTO app.adjustment_category (id, category)
 OVERRIDING SYSTEM VALUE
 VALUES (1, 'Case Management Support'),
(2, 'Group Supervision');

INSERT INTO app.adjustment_reason (id, contact_code, contact_description, category_id, points)
OVERRIDING SYSTEM VALUE
VALUES (1, 'CMS01', 'CMS - Sentence Plan Intervention Delivery - Low', 1, 9),
