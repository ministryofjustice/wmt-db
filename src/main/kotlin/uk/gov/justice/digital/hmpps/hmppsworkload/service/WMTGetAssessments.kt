...
class WMTGetAssessments(private val wmtAssessmentRepository: WMTAssessmentRepository) {
  fun getAssessments(staffIdentifier: StaffIdentifier): List<Assessment> =
    wmtAssessmentRepository.findByStaffCodeAndTeamCode(staffIdentifier.staffCode, staffIdentifier.teamCode).let { wmtAssessments ->
