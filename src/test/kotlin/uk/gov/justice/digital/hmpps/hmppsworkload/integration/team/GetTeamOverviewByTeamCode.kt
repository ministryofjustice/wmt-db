...
class GetTeamOverviewByTeamCode : IntegrationTestBase() {
  ...
  fun `can get team overview of offender managers by team code`() {
    ...
    val movedPersonManager = PersonManagerEntity(crn = "CRN3", staffId = BigInteger.valueOf(123456789L), staffCode = "OM1", teamCode = "T1", offenderName = "John Doe", createdBy = "USER1", providerCode = "R1", createdDate = ZonedDateTime.now().minusDays(5L), isActive = true)
